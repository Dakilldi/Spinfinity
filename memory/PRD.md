...
- ✅ **TV Show prize phrasing** — "WINS" / "GAGNE" replaced by "Félicitations, tu as gagné" / "Congratulations, you won" (TV Show theme only via per-theme `labels` override). (Feb 2026)
